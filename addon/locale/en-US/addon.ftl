...
menuAddon-openAddonPrefPane = TranslateAnt Setting
menuAddon-openAddonShortcut = Shortcut Setting
...
info-translateNote = Translate Note
info-baiduTranslate = Baidu Translate
info-tencentTranslate = Tencent Translate
info-increaseFontSize = Increase FontSize
info-decreaseFontSize = Decrease FontSize
info-settingPane = Open Setting Pane

info-selectedItemeZero = No Item selected
zutilo-checkItems-errorTitle = item selection error
...
zutilo-checkItems-regular2 = Please select at least two regular items.
zutilo-checkItems-regularOrNote2 = Please select at least two regular items or notes.
