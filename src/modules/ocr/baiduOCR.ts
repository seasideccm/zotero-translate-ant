...
function baiduPictureTranslate(secretKey: string) {
    ...
    return async function doit({ image, translate, sourceLang, targetLang }: BaiduOcrPictureTr) {
        ...
        const sign = Zotero.Utilities.Internal.md5(`${appid}${fileMD5}${salt}${cuid}${mac}${key}`);
...
- HIN：印地语
 */
declare type LanguageType = "CHN_ENG" | "ENG" | "JAP" | "KOR" | "FRE" | "SPA" | "POR" | "GER" | "ITA" | "RUS" | "DAN" | "DUT" | "MAL" | "SWE" | "IND" | "POL" | "ROM" | "TUR" | "GRE" | "HUN" | "THA" | "VIE" | "ARA" | "HIN";
