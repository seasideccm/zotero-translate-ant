  ...
  async save() {
    ...
    await DB.executeTransaction(async () => {
      ...
      async function valueQuery(
        ...
        let value;
        try {
          value = await DB.valueQueryAsync(valueSQL, [queryValue], {
            debug: true,
          });
        } catch (e: any) {
          ztoolkit.log(e);
      ...
      this.sourceTextID = await valueQuery(
        "sourceText",
        "sourceTextID",
        "sourceText",
        this.sourceText,
      ...
      this.targetTextID = await valueQuery(
        "targetText",
        "targetTextID",
        "targetText",
        this.targetText,
      ...
      this.translateID = await valueQuery(
        "translation",
        "translateID",
        "targetTextID",
        this.targetTextID,
      ...
      sqlValues = [
        ...
        this.originID,
        this.originKey,
        this.originLibraryID,
      ];
      await insert(
        "translationOrigin",
        ["translateID", "originID", "originKey", "originLibraryID"],
        sqlValues,
      );
    });
