export async function tencentTransmart(
  sourceText: string,
  sourceLang?: string,
  targetLang?: string,
) {
  ...
  const client_key =
    "browser-chrome-114.0.0-Windows 10-6c02f83c-d2d9-4a75-bed4-51e2ccb12be3-1689464307304";
  ...
  const xhr = await Zotero.HTTP.request("POST", `https://yi.qq.com/api/imt`, {
    headers: {
